...
coefficientsRandom = numpy.random.random(20) * 1e-9     #Random sampling
...
maxiter = 10000
fatol = 1e-2    # Absolute error in input variables x between iterations
xatol = 1e-2    # Absolute error in f(x) between iterations
